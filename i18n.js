...
(function () {
  ...
  var T = {
    ...
    "Sites web": { en: "Websites", de: "Websites", it: "Siti web", nl: "Websites" },
    "Sites vitrines modernes et multilingues : restaurants, salons de coiffure, instituts, bars, photographie.": { en: "Modern, multilingual showcase sites: restaurants, hair salons, beauty institutes, bars, photography.", de: "Moderne, mehrsprachige Visitenkarten-Websites: Restaurants, Friseure, Kosmetikinstitute, Bars, Fotografie.", it: "Siti vetrina moderni e multilingue: ristoranti, parrucchieri, istituti di bellezza, bar, fotografia.", nl: "Moderne, meertalige vitrinesites: restaurants, kapsalons, schoonheidsinstituten, bars, fotografie." },
    "12 réalisations →": { en: "12 projects →", de: "12 Referenzen →", it: "12 realizzazioni →", nl: "12 realisaties →" },
    "Applications": { en: "Applications", de: "Anwendungen", it: "Applicazioni", nl: "Applicaties" },
